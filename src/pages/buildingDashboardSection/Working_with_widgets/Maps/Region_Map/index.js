...
export const RegionMap = () => {
  ...
  return (
    <div className="mainPage">
      <h1 className="padding-Top">Region Map</h1>
      <p>
        <li>
          <span className="bold-text">Properties</span>
        </li>
        In order to add data to your Region map, you have to access the <span className="bold-text">Properties</span> of the widget.
      </p>
     ...
     <br />
      <div>
        ...
        <li>
          <span
            className="pageLink"
            onClick={() => history.push("/CountryRegions")}
          >
            Country Regions
          </span>
        </li>
