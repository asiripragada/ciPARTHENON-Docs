...
export const BarChart = () => {
  return (
    <div className="BarChart">
      ...
      <p>
      The bar chart is a graph with horizontal bars whose lengths are proportional to the values that they represent. It displays the aggregated values associated with items included in a category like regions, departments, age groups etc.
      <br />
