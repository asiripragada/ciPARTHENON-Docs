...
export const ScatterChart = () => {
  return (
    <div className="ScatterChart">
      <h1 className="padding-Top">Scatter Chart</h1>
      <p>
      The Scatter chart is a type of mathematical diagram using Cartesian coordinates to display values for typically two variables within a single set of data.The data is displayed as a collection of points, each having the value of one variable determining the position on the horizontal axis and the value of the other variable determining the position on the vertical axis
      <br />
      In order to build a Scatter chart, you have to drag and drop the widget into the dashboard work space area. 
      <br/>
      <li>
        Properties
      </li>
      ...
      <p>
        ...
        <br />
        If you choose this option, click on Data tab and link your Scatter chart with an already imported data source. Click on the <span className="bold-text">Select A Datasource </span>search bar and select your data set. All the columns are added in the left end side of the screen. 
      ...
      You have to add the numeric columns into the X-axis and Y-axis section. If you want every value from the X and Y-axis section to be split by another criteria, you have to add the dimension in the <span className="bold-text">Series </span>section. 
      <br />
