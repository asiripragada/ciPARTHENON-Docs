...
export const AccessingDashboards = () => {
  ...
  return (
    <div className="mainPage">
      ...
      <p>The <span className="bold-text">Dashboard</span> menu allows to visualize all the dashboards you have created or the ones that have been shared with you, make changes on the properties, schedules, security or other actions. Via the <span className="bold-text">Dashboard</span> menu,you can also access the dashboards in the edit mode or create a new one.
      </p>
      <br />
