...
export const Shape = () => {
  return (
    <div className="Shape">
      <h1 className="padding-Top">shape</h1>
      <p>
      The Shape widget as with the Ballon and Note widget, is a widget in which the user can  input some ideas or notes that allow a clear visualization of the key results of a dashboard. But the user can choose various shapes
      <br />
      ...
      In This section you can choose to rename the widget, change the style of the widget. You can also Lock the position in the dashboard. You can have data based on text or a formula. The feature of this widget this that you can change the shape to (Circle, Triangle, Rectangle or Star).
      </p>
      <br />
