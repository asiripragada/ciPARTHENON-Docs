...
export const AreaChart = () => {
  return (
    <div className="AreaChart">
      <h1 className="padding-Top">Area Chart</h1>
      <p>
      The area chart is a graph which displays graphically quantitative data. It is based on the line chart, the difference is that the area between the axis and the line are emphasized with colors.

      <br />

      In order to build an area chart, you have to drag and drop the widget into the dashboard work space area.
