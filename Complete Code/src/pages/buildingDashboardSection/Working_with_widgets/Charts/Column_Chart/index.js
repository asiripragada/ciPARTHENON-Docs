...
export const ColumnChart = () => {
  return (
    <div className="ColumnChart">
      <h1 className="padding-Top">Column Chart</h1>
      <p>
      The Column chart is a graph with horizontal bars whose lengths are proportional to the values that they represent. It displays the aggregated values associated with items included in a category like regions, departments, age groups etc.
      <br />
      ...
      <p>
        ...
        <br />
        If you choose this option, click on Data tab and link your Column chart with an already imported data source. Click on the <span className="bold-text">Select A Datasource </span>search bar and select your data set. All the columns are added in the left end side of the screen. 
