...
export const PieChart = () => {
  return (
    <div className="PieChart">
      <h1 className="padding-Top">Pie Chart</h1>
      <p>
      The  pie chart  is a circular graph which displays data proportional to the quantity that it represents.
      <br />
      In order to build a bar chart, you have to drag and drop the widget into the dashboard work space area. 
      A new window will appear that allows you to customize the chart's properties. 
      <br/>
      <li>
        Properties
      </li>
      In this section you can name the chart, set up a style and choose the colors of the slices. 
      ...
      <p>
        ...
        <br />
        If you choose this option, click on Data tab and link your Pie chart with an already imported data source. Click on the <span className="bold-text">Select A Datasource </span>search bar and select your data set. All the columns are added in the left end side of the screen. 
      ...
      You have to add the numeric columns into the <span className="bold-text">Value </span>section, the dimensions into the <span className="bold-text">Categories </span>section. In case you want every value from the category section to be split by another criteria, you have to add the dimension in the <span className="bold-text">Series </span>section. Here, you have the option of setting up the aggregation needed for the value. If you click on Sum below the column name, you will see the different aggregations possible you can apply on your measure. 
      ...
      <p>
        ...
        <br />
        If you choose this option, click on the f(x) button and build your own formula using our Formula Editor Menu. You can learn how to build formulas here.
        <br />
      ...
      <li>
        ...
        <br />
        In this section you can select the data you want to show in the Pie Chart. 
