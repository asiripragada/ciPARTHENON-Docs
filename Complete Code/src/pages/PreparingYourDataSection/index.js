  ...
  return (
    <div className="mainPage">
      ...
      <div>
        ...
        <li>
          <span className="pageLink" onClick={() => history.push("/DataTransformations")}>
            Data Transformations
            </span>
        </li>
        <li>
          <span className="pageLink" onClick={() => history.push("/MyConnections")}>
            My Connections
            </span>
        </li>
        <li>
          <span className="pageLink" onClick={() => history.push("/DataStream")}>
            Data Stream
            </span>
        </li>
        <li>
          <span className="pageLink" onClick={() => history.push("/DataFusion")}>
            Data Fusion
            </span>
        </li>
      </div>
