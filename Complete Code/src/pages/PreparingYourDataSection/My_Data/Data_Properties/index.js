...
import image9 from "./images/Picture9.gif";
...
export const DataProperties = () => {
  return (
    <div className="dataProperties">
      ...
      <p>
        <li>
          <span className="bold-text_Header">Properties</span>
        </li>
      ...
      <p>
        <li>
          <span className="bold-text_Header">Schema</span>
        </li>
      ...
      <p>
        <li>
          <span className="bold-text_Header">Usage</span>
        </li>
      ...
      <p>
        <li>
          <span className="bold-text_Header">Schedules</span>
        </li>
        - If your data source was uploaded through a data connection, you
        can see the
        <span className="bold-text"> schedules </span>
      ...
      <p>
        <li>
          <span className="bold-text_Header">History</span>
        </li>
      ...
      <p>
        <li>
          <span className="bold-text_Header">Security</span>
        </li>
      ...
      <p>
        <li>
          <span className="bold-text_Header">Cache</span>
        </li>
      ...
      <p>
        <li>
          <span className="bold-text_Header">Live Link</span>
        </li>
      ...
      <p>
        <li>
          <span className="bold-text_Header">Tasks</span>
        </li>
