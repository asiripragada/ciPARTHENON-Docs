...
export const StepsNeedToFollow = () => {
  return (
    <div className="StepsNeedToFollow">
      ...
      <p>
          <span className="bold-text">Step 1:Choose the column</span><br/>
      ...
      <p><span className="bold-text">Additional Actions</span>
      <br/>
      When selecting a row you have a new set of actions available:
      <br/>
      You have the ability to copy/ paste above/paste below/insert a row above/insert a row below
      </p>
