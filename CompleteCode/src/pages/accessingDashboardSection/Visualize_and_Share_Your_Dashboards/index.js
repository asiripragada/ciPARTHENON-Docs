    ...
    <div className="VisualizeAndShareYourDashboards">
      ...
      Once your dashboard has been built, you can view and/or share your dashboard in several ways.
       ...
       <p>
          ...
          <span className="bold-text_Header">1)Within ciPARTHENON</span>
       ...
       <p>
        ...
        <p>        
          <span className="bold-text_Header">2)Live Link</span>
        </p>           
        <p>
        ...
        <p>        
          <span className="bold-text_Header">3)Schedule</span>      
        </p>
