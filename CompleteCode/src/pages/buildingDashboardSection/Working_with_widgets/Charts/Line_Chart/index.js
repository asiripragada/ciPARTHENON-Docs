...
export const LineChart = () => {
  return (
    <div className="LineChart">
      <h1 className="padding-Top">Line Chart</h1>
      <p>
      The line chart is a graph which displays quantitative data as a series of data points called 'markers' connected by straight line segments.

      <br />

      In order to build a line chart, you have to drag and drop the widget into the dashboard work space area. 
      ...
      <p>
        ...
        <br />
        If you choose this option, click on Data tab and link your Line chart with an already imported data source. Click on the <span className="bold-text">Select A Datasource </span>search bar and select your data set. All the columns are added in the left end side of the screen. 
