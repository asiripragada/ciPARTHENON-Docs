...
export const NumberIndicator = () => {
  return (
    <div className="NumberIndicator">
      <h1 className="padding-Top">Number Indicator</h1>
      <p>
      If you want to add a single value to show in the dashboard, you can use the <span className="bold-text">Number Indicator </span>includes in the <span className="bold-text">Indicators </span>catogary
      <br />
      ...
      <p>
        ...
        <br />
        In this section, you can filter the data shown on the Number Indicator by applying filters.
        <br />
      ...
      <p>
        ...
        <br />
        The interaction section allows you to choose the action which will be performed when you double click or hover on the <span className="bold-text">Number indicator</span>. You can display a new dashboard/navigate to a URL in a new tab, or display the ToolTip respectively.
      </p>
      <br />
