...
export const Balloon = () => {
  return (
    <div className="Balloon">
      <h1 className="padding-Top">Balloon</h1>
      <p>
      The Ballon widget is a widget in which the user can  input some ideas or notes that allow a clear visualization of the key results of a dashboard.
      <br />
      In order to build a Ballon, you have to drag and drop the widget into the dashboard work space area. 
      <br />
